...
class Mastalab_comments {
	...
	public function __construct() {
		if ( defined( 'MASTALAB_COMMENT_VERSION' ) ) {
			$this->version = MASTALAB_COMMENT_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action('admin_init', $plugin_admin,'register_session', 1);
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('the_content', $plugin_public, 'mastalab_comments_add_to_footer', 1);
